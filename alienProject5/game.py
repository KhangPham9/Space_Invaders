...
class Game:
    ...
    def __init__(self):
        ...
        self.lasers = Lasers(game=self, owner=self.ship, alien_fleet=self.alien_fleet)                  # for ship lasers
        # self.alien_lasers = Lasers(game=self, owner=self.alien_fleet, alien_fleet=self.alien_fleet)   # for alien lasers
        self.ship.set_alien_fleet(self.alien_fleet)
        self.ship.set_lasers(self.lasers)
        self.barrier = Barriers(game=self, ul=(10, 500))
