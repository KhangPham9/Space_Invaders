...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/level0alien{n}.png'), 0, 1) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/level1alien{n}.png'), 0, 1) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/level2alien{n}.png'), 0, 1) for n in range(2)]
